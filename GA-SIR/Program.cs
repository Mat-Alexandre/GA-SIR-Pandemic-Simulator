...
int popSize = 20, bitSize = 10, numGenerations = 300, days = susPerDay.Length;
...
Utils.PrintInitialConfig(args[0], popSize, numGenerations, bitSize, days, reprodutionRate, crossoverRate, mutationRate, totalNodes);
